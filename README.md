# Self-Operating-ATM-System
A comprehensive Object-Oriented Programming (OOP) implementation of an Automated Teller Machine (ATM) System in C++, featuring secure user authentication, transaction management, account validation, and persistent data handling via File I/O.
Detailed implementation of a terminal-based Automated Teller Machine (ATM) system developed in C++. 
...
Developed as a semester project to demonstrate core software engineering and OOP principles.
* C++ Developer / Robotics Enthusiai *
